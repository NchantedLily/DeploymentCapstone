                ...
                <div className="flip-card1">
                  <div className="flip-card-inner1">
                    ...
                    <div className="flip-card-back1">
                      ...
                      <a href=" https://www.americansignmuseum.org/" className="fa fa-home" /> 
                ...
                <div className="flip-card1">
                  <div className="flip-card-inner1">
                    ...
                    <div className="flip-card-back1">
                      ...
                      <a href="https://www.facebook.com/WashingtonParkOTR/" className="fa fa-facebook" />
                      <a href=" https://washingtonpark.org/" className="fa fa-home" /> 
                    </div>
                  </div>
                </div>
                <div className="flip-card1">
                  <div className="flip-card-inner1">
                    ...
                    <div className="flip-card-back1">
                      ...
                      <a href=" https://www.cincinnati-oh.gov/streetcar/" className="fa-solid fa-house" /> 
                    </div>
                  </div>
                </div>
                <div className="flip-card1">
